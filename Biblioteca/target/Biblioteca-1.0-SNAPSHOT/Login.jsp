...
<html lang="en">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form class="row g-3" method = "POST" action = "SvAgregarLibro"  enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <label for="validationServer03" class="form-label">A�o de Publicaci�n</label>
                                <div class="mb-3">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                <h2 align="center">�Est�s seguro de que deseas eliminar esta tarea?</h2>
  ...
  $('#exampleModal').on('show.bs.modal', function (event) {
    ...
    var titulo = button.data('titulo'); // Obtén el nombre del perro
