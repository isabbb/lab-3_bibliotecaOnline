...
<html lang="en">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form class="row g-3" method = "POST" action = "SvAgregarLibro"  enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <label for="validationServer03" class="form-label">Año de Publicación</label>
                                <div class="mb-3">
  ...
  $('#exampleModal').on('show.bs.modal', function (event) {
    ...
    var titulo = button.data('titulo'); // ObtÃ©n el nombre del perro

    // Realiza una solicitud AJAX al servlet para obtener los detalles del perro por su nombre
    $.ajax({
      url: 'SvAgregarLibro?titulo=' + titulo, // Cambia 'id' por el nombre del parÃ¡metro que esperas en tu servlet
      method: 'GET',
